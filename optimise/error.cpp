...
static void writeFIle(char errorChar)
{
...
void error(int errorType)
{
	...
	case 	SHOULD_BE_SEMI:
		...
		errorfile << words.at(Token::pos - 2).line << " " << "k" << endl;
		break;
		//k
	case 	SHOULD_BE_RPARENT:
		errorfile << words.at(Token::pos - 2).line << " " << "l" << endl;
		break;
		//l
	case 	SHOULD_BE_RBRACK:
		errorfile << words.at(Token::pos - 2).line << " " << "m" << endl;
		break;
		//m
